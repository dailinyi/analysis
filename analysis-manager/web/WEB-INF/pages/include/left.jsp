                    ...
                    <ul data-options="state:'closed'">
                        ...
                        <li>
                            ...
                            <ul data-options="state:'closed'">
                                ...
                                <li><span><a href="##" id="HTTP-guardian-防火墙规则" url="<%=basePath%>/alert/listWall.do?serverName=FTP">防火墙规则</a></span></li>
                    ...
                    <ul data-options="state:'closed'">
                        ...
                        <li>
                            ...
                            <ul data-options="state:'closed'">
                                ...
                                <li><span><a href="##" id="FTP-guardian-防火墙规则" url="<%=basePath%>/alert/listWall.do?serverName=FTP">防火墙规则</a></span></li>
